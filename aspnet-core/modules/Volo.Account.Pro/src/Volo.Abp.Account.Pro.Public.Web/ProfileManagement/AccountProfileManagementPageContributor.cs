...
using Volo.Abp.Account.Public.Web.Pages.Account.Components.ProfileManagementGroup.AuthenticatorApp;
...
public class AccountProfileManagementPageContributor : IProfileManagementPageContributor
{
    public async Task ConfigureAsync(ProfileManagementPageCreationContext context)
    {
        ...
        context.Groups.Add(
            new ProfileManagementPageGroup(
                "Volo-Abp-Account-AuthenticatorApp",
                l["ProfileTab:AuthenticatorApp"],
                typeof(AccountProfileAuthenticatorAppGroupViewComponent)
            )
        );
