    ...
    public class FaceAPIAuthServerModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<FaceAPIDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}FaceAPI.Domain.Shared", Path.DirectorySeparatorChar)));
                options.FileSets.ReplaceEmbeddedByPhysical<FaceAPIDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}FaceAPI.Domain", Path.DirectorySeparatorChar)));
            });
        }
    ...
    private X509Certificate2 GetSigningCertificate(IWebHostEnvironment hostingEnv, IConfiguration configuration)
    {
        ...
        var passPhrase = "07051b0d-1ec9-40bb-ac2d-57fdc6c1fd15";
