    ...
    public class FaceAPIEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<FaceAPIDbContext>(options =>
        {
            ...
            options.AddRepository<Salary, Salaries.EfCoreSalaryRepository>();

            options.AddRepository<Schedule, Schedules.EfCoreScheduleRepository>();
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also FaceAPIDbContextFactory for EF Core tooling. */
