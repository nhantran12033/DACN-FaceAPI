...
{
    [DbContext(typeof(FaceAPIDbContext))]
    [Migration("20240414105723_Updated_Timesheets_423232304040040040404")]
    partial class Updated_Timesheets_423232304040040040404
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaceAPI.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("FaceAPI.Departments.DepartmentTitle", b =>
                {
                    ...
                    b.HasKey("DepartmentId", "TitleId");

                    b.HasIndex("TitleId");

                    b.HasIndex("DepartmentId", "TitleId");

                    b.ToTable("AppDepartmentTitle", (string)null);
                });

            modelBuilder.Entity("FaceAPI.Positions.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FaceAPI.Schedules.ScheduleScheduleDetail", b =>
                {
                    ...
                    b.HasKey("ScheduleId", "ScheduleDetailId");
