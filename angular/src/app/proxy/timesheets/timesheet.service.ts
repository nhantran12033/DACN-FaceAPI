    ...
    this.restService.request<any, PagedResultDto<TimesheetWithNavigationPropertiesDto>>(
      {
        ...
        params: {
          ...
          code: input.code,
          timeInMin: input.timeInMin,
          timeInMax: input.timeInMax,
          timeOutMin: input.timeOutMin,
          timeOutMax: input.timeOutMax,
          hoursWorkMin: input.hoursWorkMin,
          hoursWorkMax: input.hoursWorkMax,
          note: input.note,
