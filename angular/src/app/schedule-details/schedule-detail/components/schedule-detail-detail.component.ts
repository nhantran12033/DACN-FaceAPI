...
@Component({
  selector: 'app-schedule-detail-detail',
  ...
  templateUrl: './schedule-detail-detail.component.html',
  styles: [],
})
export class ScheduleDetailDetailComponent {
  public readonly service = inject(ScheduleDetailDetailViewService);
}
